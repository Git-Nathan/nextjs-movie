...
export default function PosterPopover(item: IMovieBox) {
  const t = useTranslations('Tooltip')

  return (
    <div className="movie-box z-10 flex aspect-[240/361] w-full flex-col">
      <Image
      ...
      />
      <div className="movie-card absolute left-1/2 top-1/2 z-10 flex h-[480px] w-[92vw] max-w-[305px] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-lg border border-solid border-[#353843] bg-neutral600 shadow-[0px_4px_15px_0px_rgba(255,255,255,0.10)]">
        <div
          className="movie-card__top flex h-full w-[305px] items-end justify-center bg-[cover] bg-no-repeat"
          style={{
            backgroundImage: `url('${getImageUrl(item.poster_path)}')`,
          }}
        >
          <div
            className="h-full w-[305px] translate-y-px bg-[cover] bg-no-repeat"
            style={{
